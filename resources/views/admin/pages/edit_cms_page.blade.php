...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">CMS Pages</a> <a href="#" class="current">Edit Product</a> </div>
    <h1>CMS Pages</h1>
          ...
          <div class="widget-content nopEditing">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-cms-page/'.$cmsPage->id) }}" name="Edit_cms_page" id="Edit_cms_page" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="meta_description" id="meta_description" value="{{ $cmsPage->meta_keywords }}">
                </div>
              </div>
