              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div id="uniform-undefined">
                          ...
                          @if(!empty($productDetails->pdf))
                          <input type="hidden" name="current_pdf" value="{{ $productDetails->pdf }}"> 
                          <a target="_blank" href="{{ url('pdfs/'.$productDetails->pdf)}}">View</a>
                          <a href="{{ url('/admin/delete/delete-product-pdf'.$productDetails->id)}}">Delete</a>
                          @endif
                </div>
              </div>
              <div class="control-group">
