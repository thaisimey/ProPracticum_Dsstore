        ...
        <div class="mdl-card mdl-card__login mdl-shadow--2dp">
                ...
                <div class="alert alert-success alert-block">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="login-name text-color--smoke">Sign in</span>
                            <span class="login-secondary-text text-color--smoke">Enter your information to login</span>
                        </div>
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                            <a href="{{ url('/userregister') }}" class="text-color--smoke">Don't have account?</a>
