...
class UsersController extends Controller
{
    ...
    public function userRegister(){
        $meta_title = "User register - Ecom website";
        return view('users.userregister')->with(compact('meta_title'));    
    }

    public function userLogin(){
        $meta_title = "User login - Ecom website";
        return view('users.userlogin')->with(compact('meta_title')); ;    
    }
    ...
    public function forgotPassword(Request $request){
        if($request->isMethod('post')){
            ...
            // echo "count"; print_r($userCount);
            if($userCount == 0){
                return redirect()->back()->with('flash_message_error','Email does note exists!');
            }
            // die;
            // Get user details
        ...
        Mail::send('emails.forgotpassword',$messageData,function($message)use($email){
            ...
            return redirect('/userlogin')->with('flash_message_error','Please check your email for new password!');
