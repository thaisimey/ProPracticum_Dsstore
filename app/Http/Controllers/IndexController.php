...
class IndexController extends Controller
{
    ...
    // $productsAll = json_decode(json_encode($productsAll));
		...
		// Meta tags
		$meta_title = "Bookfreak website";
		$meta_description = "Online shopping for men, women and kids books,all types of books";
		$meta_keywords = "Bookfreak website, online shopping site,kids book,Ecommerce website,bookstore";
